...
Cascade is a modeling tool allowing gene selection, reverse engineering,
and prediction in cascade networks. Jung, N., Bertrand, F., Bahram, S.,
Vallat, L., and Maumy-Bertrand, M. (2014)
<https://doi.org/10.1093/bioinformatics/btt705>.

The package was presented at the
[User2014!](https://user2014.r-project.org/) conference. Jung, N.,
Bertrand, F., Bahram, S., Vallat, L., and Maumy-Bertrand, M. (2014).
“Cascade: a R-package to study, predict and simulate the diffusion of a
signal through a temporal genenetwork”, *book of abstracts*, User2014!,
Los Angeles, page 153,
<https://user2014.r-project.org/abstracts/posters/181_Jung.pdf>.

![Reverse-engineered network.](reference/figures/figure_article_def.png)

Reverse-engineered network.

![Simulation of an intervention on a gene of the
network.](reference/figures/figure_network_pred2.png)
...
You can install the released version of Cascade from
...
Import Cascade Data (repeated measurements on several subjects) from the
CascadeData package and turn them into a micro array object. The second
line makes sure the CascadeData package is installed.
...
![plot of chunk
plotmicroarrayclass](reference/figures/README-plotmicroarrayclass-1.png)

plot of chunk plotmicroarrayclass

![plot of chunk
plotmicroarrayclass](reference/figures/README-plotmicroarrayclass-2.png)
...
We set the seed to make the results reproducible and draw a scale free
random network.
...
We simulate gene expression according to the network that was previously
drawn
...
![plot of chunk
summarysimuldata](reference/figures/README-summarysimuldata-1.png)

plot of chunk summarysimuldata

![plot of chunk
summarysimuldata](reference/figures/README-summarysimuldata-2.png)

plot of chunk summarysimuldata

![plot of chunk
summarysimuldata](reference/figures/README-summarysimuldata-3.png)
...
![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-1.png)

plot of chunk plotsimuldata

![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-2.png)

plot of chunk plotsimuldata

![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-3.png)

plot of chunk plotsimuldata

![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-4.png)

plot of chunk plotsimuldata

![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-5.png)

plot of chunk plotsimuldata

![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-6.png)

plot of chunk plotsimuldata

![plot of chunk
plotsimuldata](reference/figures/README-plotsimuldata-7.png)

plot of chunk plotsimuldata

### Network inference

We infer the new network using subjectwise leave one out
cross-validation (all measurement from the same subject are removed from
the dataset)
...
![plot of chunk netinf](reference/figures/README-netinf-1.png)

plot of chunk netinf

![plot of chunk netinf](reference/figures/README-netinf-2.png)
...
![plot of chunk heatresults](reference/figures/README-heatresults-1.png)

plot of chunk heatresults

\###Post inferrence network analysis We switch to data that were derived
from the inferrence of a real biological network and try to detect the
optimal cutoff value: the best cutoff value for a network to fit a scale
free network.
...
![plot of chunk
cutoff](reference/figures/README-cutoff-1.png "plot of chunk cutoff")
...
Analyze the network with a cutoff set to the previouly found 0.14
optimal value.
